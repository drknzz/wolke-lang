...
layoutWords = [( TokSymbol ":" 12
               , LayoutDelimiters (TokSymbol ";" 13) (Just (TokSymbol "{" 39)) (Just (TokSymbol "}" 41))
               )]

layoutStopWords :: [TokSymbol]
layoutStopWords = [TokSymbol "else" 31]
